...
export default function AreaPage() {
  ...
  const { data, isLoading } = useFilterByArea(areaName || "");
  ...
  return (
    ...
    >
      ...
      <header className="relative w-full h-[260px] sm:h-[320px] lg:h-[380px] overflow-hidden mb-14">
        {/* Background (generic world food image or area flag image) */}
        <div
        ...
        <div className="relative z-10 flex flex-col items-center justify-center h-full text-center px-6">
          ...
          >
            Explore traditional meals from {areaName}.
          </motion.p>
        </div>
      </header>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-10">
            {data?.meals?.map((meal, i) => (
              <motion.div
                ...
                className={`relative rounded-xl overflow-hidden cursor-pointer group shadow-lg transition-all duration-500 ${
